...
const page = () => {
  return (
    ...
    >
      <GalleryHeader />
      <section className="flex flex-col md:flex-row items-center  px-6 md:px-20 h-full">
        <div className="flex justify-center md:items-center gap-7 h-full ">
        ...
        <div className="md:ml-16 text-center md:text-left flex flex-col justify-around h-full">
          <h2 className="self-start font-normal text-sm px-3 py-2 my-3 bg-[#FDD604] text-white rounded-3xl  ">
            Contact Us
          </h2>
          <h2 className="xl:text-5xl 2xl:text-6xl font-medium text-gray-900 mb-4 select-none">
            We’re Here to Help You Care for Your{" "}
            <span className="">Aquatic World</span>
          </h2>
          <p className="text-gray-600 mb-12 select-none xl:text-base 2xl:text-lg ">
          ...
          <div className="flex justify-between items-center text-white font-semibold rounded-md w-full h-full">
            <div className="flex-1 w-full h-[30vh] rounded-3xl mr-2 border-2 border-slate-200/70 flex flex-col justify-around items-center p-3 hover:shadow-lg transition-shadow text-black">
            ...
            <div className="flex-1 w-full h-[30vh] border-2 border-slate-200/70 rounded-3xl ml-2 flex flex-col justify-around items-center p-3 hover:shadow-lg transition-shadow text-black">
